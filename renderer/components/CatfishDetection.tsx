  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      saveHistoryItem({
        ...
        outputSummary: `${result.realnessScore}/100 ${result.riskLevel}`,
      });
      setRecent(listHistory("catfish").slice(0, 3));
    } catch (error) {
            ...
            >
              ...
              <div style={{ textAlign: "center", marginBottom: "20px" }}>
                <h3
                  style={{
                    margin: "0 0 8px 0",
                    color: getScoreColor(analysis.realnessScore),
                    fontSize: "20px",
                    fontWeight: "500",
                  }}
                >
                ...
                >
                  <div
                    style={{
                      ...
                      height: "100%",
                      backgroundColor: getScoreColor(analysis.realnessScore),
                      borderRadius: "4px",

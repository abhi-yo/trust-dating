...
} from "../lib/conversationQualityChecker";
...
export default function ConversationQuality({
  onClose,
  onBack,
}: ConversationQualityProps) {
  const [conversationText, setConversationText] = useState("");
  const [analysis, setAnalysis] = useState<ConversationQualityResult | null>(
    null
  );
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      saveHistoryItem({
        ...
        outputSummary: `${result.engagementLevel} ${result.overallScore}/100`,
      });
      setRecent(listHistory("quality").slice(0, 3));
    } catch (error) {
              ...
              <div style={{ marginTop: 8 }}>
                ...
                <div style={{ display: "grid", gap: 6 }}>
                  {recent.map((h) => (
                    <button
                      key={h.id}
                      onClick={() => setConversationText(h.inputText)}
                      style={{
            ...
            >
              ...
              <div style={{ textAlign: "center", marginBottom: "20px" }}>
                <h3
                  style={{
                    margin: "0 0 8px 0",
                    color: getEngagementColor(analysis.engagementLevel),
                    fontSize: "20px",
                    fontWeight: "500",
                  }}
                >
              ...
              {analysis.exampleBetterReplies &&
                analysis.exampleBetterReplies.length > 0 && (
                  <div>
                    <h4
                      style={{
                        margin: "0 0 8px 0",
